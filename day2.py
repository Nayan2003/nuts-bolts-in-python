...
'''
#---------------------------------Barai sir task---------------------------------
'''# Q 1. find maximum between two numbers.
...
# # if num_1>num_2:
# #     print("first Number is maximum_1")
# # elif num_3<num_1:
# #     print("first Number is maximum_2")
# # elif num_2>num_1:
# #     print("Second Number is maximum_1")
# # elif num_2>num_3:
# #     print("Second Number is maximum_2")
# # elif num_1<num_3:
# #     print("third number is maximum_1")
# # elif num_2<num3:
# #     print("Third number is maximum_2")
print("nayan")